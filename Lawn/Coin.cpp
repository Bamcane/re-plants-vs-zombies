...
{
    // �������ԭ������ȫû�еģ����������� Board ���漰�������Ҹо�������Ҫ������Ǯ�������ʱ���ṩ���㣬���Ծ���������
    ...
    if (IsPresentWithAdvice())
    {
        if (mCollectionDistance < 15.0f)
        {
            if (!mBoard->mHelpDisplayed[(int)AdviceType::ADVICE_UNLOCKED_MODE])
            {
                ...
                {
                    // ע���˴��� theMessageStyle ������ԭ����Ϊ MESSAGE_STYLE_HINT_TALL_UNLOCKMESSAGE���ڲ����Ϊ MESSAGE_STYLE_HINT_TALL_8SECONDS
...
void Coin::Update()
{
    ...
    if (mAttachmentID != AttachmentID::ATTACHMENTID_NULL)
    {
        ...
        {
            AttachmentOverrideColor(mAttachmentID, Color(0, 0, 0, 0));  // �˶��еĽ�Һ�����ʹ����ͼ�����Դ˷����ظ����Ķ���
        }
    }
}
